...
const services = [
  ...
  },
  {
    ...
    title: 'تحویل سراسری',
    desc: 'ارسال محصولات به تمام نقاط ایران با بسته‌بندی مناسب و حمل‌ونقل ایمن. سیستم پیگیری آنلاین برای اطمینان از تحویل به موقع.',
    features: ['ارسال به سراسر ایران', 'بسته‌بندی استاندارد', 'پیگیری آنلاین', 'بیمه حمل بار'],
    color: 'blue',
  },
  {
  ...
  },
  {
    ...
    title: 'تامین فوری',
    desc: 'امکان تامین اضطراری و فوری محصولات موردنیاز پروژه‌های حساس در کوتاه‌ترین زمان ممکن.',
    features: ['موجودی فوری', 'پاسخگویی سریع', 'اولویت تحویل', 'هماهنگی با تولیدکننده'],
    color: 'cyan',
  },
];
