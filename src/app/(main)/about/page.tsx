          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-[var(--muted-foreground)] leading-relaxed mb-4">
                لوله آنلاین مشهد در سال ۱۳۸۳ با هدف تامین لوله‌های با کیفیت برای پروژه‌های عمرانی مشهد تاسیس شد. در ابتدا با تمرکز بر لوله‌های PVC (پلیکا) فعالیت آغاز کردیم.
              </p>
