        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-6 group">
              ...
              <div>
                <div className="font-bold text-xl text-white leading-tight">لوله آنلاین مشهد</div>
            ...
            <p className="text-slate-300 text-sm leading-relaxed mb-6 max-w-xs">
              با بیش از ۲۰ سال تجربه در صنعت لوله و اتصالات، تامین کننده معتبر انواع لوله، اتصالات و شیرآلات صنعتی در مشهد و سراسر ایران.
            </p>

            {/* Contact Info */}
            <div className="space-y-3">
              <a href="tel:05112345678" className="flex items-center gap-3 text-sm text-slate-300 hover:text-[var(--accent)] transition-colors group">
              ...
              <a href="mailto:info@luleonline-mashhad.ir" className="flex items-center gap-3 text-sm text-slate-300 hover:text-[var(--accent)] transition-colors group">
                <div className="w-8 h-8 rounded-lg bg-slate-800 flex items-center justify-center group-hover:bg-[var(--accent-hover)]/20 transition-colors">
                  <Mail className="w-4 h-4" />
                </div>
                info@luleonline-mashhad.ir
              </a>
              <div className="flex items-start gap-3 text-sm text-slate-300">
                <div className="w-8 h-8 rounded-lg bg-slate-800 flex items-center justify-center mt-0.5 flex-shrink-0">
                  <MapPin className="w-4 h-4" />
                </div>
                مشهد، خیابان امام رضا، پلاک ۱۲۳
              </div>
